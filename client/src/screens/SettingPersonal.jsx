...
import { Button, Col, Container, Row, Form, Modal, Nav, Card, Image } from "react-bootstrap";
import MainLayout from "../layouts/MainLayout";
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faLayerGroup, faUser, faBriefcase, faBookmark, faFileInvoiceDollar, faBuilding, faCog, faSignOutAlt, faBell, faUpload, faEdit, faTrash, faLink } from '@fortawesome/free-solid-svg-icons';
...
<Container fluid>
      ...
      <Nav variant="tabs" className="mb-3">
        <Nav.Item>
          <Nav.Link active={activeTab === 'personal'} onClick={() => handleTabChange('personal')}>
        ...
        <Nav.Item>
          <Nav.Link active={activeTab === 'socialLinks'} onClick={() => handleTabChange('socialLinks')}>
            <FontAwesomeIcon icon={faLink} /> Social Links
          </Nav.Link>
        </Nav.Item>
        <Nav.Item>
          <Nav.Link active={activeTab === 'accountSetting'} onClick={() => handleTabChange('accountSetting')}>
      ...
      {activeTab === 'personal' && (
        <>
          ...
          <Card className="mb-3">
            <Card.Body>
              <Button variant="link" onClick={() => setShowAddResume(true)}>
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              <div className="modal-header">
                ...
                <Button variant="close" onClick={() => setShowAddResume(false)} />
              </div>
              ...
              <div className="modal-footer">
                <Button variant="secondary" onClick={() => setShowAddResume(false)}>Cancel</Button>
