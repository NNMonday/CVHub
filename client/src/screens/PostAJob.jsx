  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:9999/api/jobs/insertjob",
        dataToSend
      );
          ...
          <Col md={3} className="bg-light sidebar">
            ...
            >
              ...
              <Nav defaultActiveKey="/overview" className="flex-column">
                ...
                <Nav.Link
                  href="/logout"
                  className="d-flex align-items-center mt-auto text-dark"
                >
                  ...
                  <Form.Check
                    ...
                    label={
                      <>
                        ...
                        <p className="text-muted">
                          Candidate apply job on your website, all application
                          on your own website.
                        </p>
                      </>
                    }
        ...
        >
          ...
          <Modal.Footer>
            <p>
              ...
              turpis, non pharetra nisl velit pulvinar lectus. Suspendisse
              varius at nisl aliquam.
            </p>
            <Row>
              <Col md={6}>
