                ...
                <Row className="mt-4">
                    <Col md={6}>
                        <div style={{ backgroundColor: '#add8e6', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }} className="text-center p-4 border">
                            ...
                            <FontAwesomeIcon icon={faBriefcase}  style={{ fontSize: '2em' }} />
                        </div>
                    </Col>
                    <Col md={6}>
                        ...
                        >
                            <div style={{ display: 'flex', alignItems: 'center' }}>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column' }}>
                                    <h2>Your profile editing is not completed.</h2>
                                    <span>Complete your profile editing & build your custom Resume</span>
                                </div>
                            </div>
                            <Button
                                style={{
