        ...
        <Col xs="auto" className="d-flex flex-column align-items-start">
          ...
          <div className="mt-2">
            <span className="text-muted">
              Job expire in: <span className="text-danger">{jobExpire}</span>
            </span>
          </div>
          <ApplyJobPopup
            show={showPopup}
            ...
            <Card style={{ bottom: "250px" }}>
              <Card.Body>
                <Row className="align-items-center mb-3">
                  <Col xs="auto">
                    <img
                      src="path_to_instagram_logo.png"
                      alt="Instagram"
                      width="50"
                      height="50"
                    />
                ...
                <Row className="mb-2">
                  ...
                  <Col>
                    <strong>120-300 Companies</strong>
                  </Col>
                </Row>
                <Row className="mb-2">
                  <Col xs={5}>
                ...
                <Row className="mb-2">
                  ...
                  <Col>
                    <strong>twitter@gmail.com</strong>
                  </Col>
                </Row>
                <Row className="mb-3">
                  <Col xs={5}>
                  ...
                  <Col>
                    <strong>https://twitter.com</strong>
                  </Col>
                </Row>
                <div>
                  <FontAwesomeIcon
